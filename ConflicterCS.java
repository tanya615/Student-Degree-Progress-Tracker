...
/*
 * 
 * ConflicterCS class uses insertCor() function to take in Node to AVL tree and String Name of class checks the 
 * class times in the AVL tree and inputs them into a 2D array to check for time conflicts.
 * 
 * This class also can print a text file of all successfully adds.
 * 
 */


public class ConflicterCS
{
    ...
    public boolean insertCor(CSmajor thetre, String Name) //throws IOException
    {
